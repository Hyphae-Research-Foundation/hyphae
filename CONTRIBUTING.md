...
pushes, force pushes, and deletion of `main` remain prohibited by repository
protection; releases are tags on an exact, verified `main` commit. Delete
obsolete PR branches after their useful changes are merged or their PRs are
deliberately closed. Release and
