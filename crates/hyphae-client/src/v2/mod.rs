...
pub use hyphae_native_product::{
    ...
    ProductScope, ProductSearchRequest, ProductSqlResult, ProductStructureMutationBatchReceipt,
    ProductStructureMutationOutcome, ProductTransactionId, ProductTransactionState,
