...
- Software is licensed under the GNU General Public License version 3 only
  (`GPL-3.0-only`). This includes source code, tests, examples, build and
...
licensing that contribution under `GPL-3.0-only`; submitting documentation
