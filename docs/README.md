...
- [4.0.0 publication receipt](release/receipts/4.0.0.md)
...
- [Universal self-hosted data engine decision](adr/0032-universal-self-hosted-data-engine.md)
...
- [ANN delta overlay format v1 (point mutation and absence fencing)](storage/ann-delta-overlay-format-v1.md)
...
- [4.0.0 exact-SHA G8 closure](gates/evidence/closures/native-g8-7cbcf97.json)
