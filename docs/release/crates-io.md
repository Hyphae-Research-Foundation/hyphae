...
exact version `2.0.0` from annotated tag `v2.0.0`. The version, immutable
...
1. Land version `2.0.0`, then create existing annotated tag `v2.0.0`. The
...
Also create a minimal Rust application with exact `=2.0.0` dependencies on
