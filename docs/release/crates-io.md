...
exact version `2.0.1` from annotated tag `v2.0.1`. The version, immutable
...
1. Land version `2.0.1`, then create existing annotated tag `v2.0.1`. The
...
Also create a minimal Rust application with exact `=2.0.1` dependencies on
