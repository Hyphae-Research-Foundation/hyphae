...
exact version `1.2.2` from annotated tag `v1.2.2`. The version, immutable
...
1. Land version `1.2.2`, then create existing annotated tag `v1.2.2`. The
...
Also create a minimal Rust application with exact `=1.2.2` dependencies on
