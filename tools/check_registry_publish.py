...
EXPECTED_CHECKS = (
    ...
    ("Package x86_64-unknown-linux-gnu", ".github/workflows/release.yml", "push", "v2.0.0"),
    ("Package x86_64-apple-darwin", ".github/workflows/release.yml", "push", "v2.0.0"),
    ("Package aarch64-apple-darwin", ".github/workflows/release.yml", "push", "v2.0.0"),
    ("Package x86_64-pc-windows-msvc", ".github/workflows/release.yml", "push", "v2.0.0"),
    ("Assemble and verify release candidate", ".github/workflows/release.yml", "push", "v2.0.0"),
    ("Publish GitHub release", ".github/workflows/release.yml", "push", "v2.0.0"),
...
def _policy(root: Path) -> dict[str, Any]:
    ...
    if (
        ...
        raise GateFailure("registry authority policy differs from the pinned 2.0.0 authority")
    return value
...
def resolve_live_authority(
    *,
    ...
    if source_commit != origin_main:
        raise GateFailure("v2.0.0 target is not the exact origin/main commit")
...
def validate_evidence_receipt(value: dict[str, Any], ecosystem: str, authority: dict[str, Any]) -> None:
    ...
    if (
        ...
        or value.get("package_inventory", {}).get("version") != "2.0.0"
    ):
